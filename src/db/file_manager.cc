...
//     int record_size = table_info->record_length + sizeof(int);
...
//         int count = table_info->field_info.size();
//         for (int i = 0; i < count; ++i)
//         {
//             const std::string &field_name = table_info->field_info.at(i).field_name;
